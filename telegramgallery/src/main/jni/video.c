...
JNIEXPORT int Java_com_tangxiaolv_telegramgallery_utils_VideoUtils_convertVideoFrame(JNIEnv *env, jclass class, jobject src, jobject dest, int destFormat, int width, int height, int padding, int swap) {
