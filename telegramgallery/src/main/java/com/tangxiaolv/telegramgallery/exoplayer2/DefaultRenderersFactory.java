...
import com.tangxiaolv.telegramgallery.exoplayer2.audio.AudioCapabilities;
import com.tangxiaolv.telegramgallery.exoplayer2.audio.AudioProcessor;
import com.tangxiaolv.telegramgallery.exoplayer2.audio.AudioRendererEventListener;
import com.tangxiaolv.telegramgallery.exoplayer2.audio.MediaCodecAudioRenderer;
import com.tangxiaolv.telegramgallery.exoplayer2.drm.DrmSessionManager;
import com.tangxiaolv.telegramgallery.exoplayer2.drm.FrameworkMediaCrypto;
import com.tangxiaolv.telegramgallery.exoplayer2.mediacodec.MediaCodecSelector;
import com.tangxiaolv.telegramgallery.exoplayer2.metadata.MetadataRenderer;
import com.tangxiaolv.telegramgallery.exoplayer2.text.TextRenderer;
import com.tangxiaolv.telegramgallery.exoplayer2.trackselection.TrackSelector;
import com.tangxiaolv.telegramgallery.exoplayer2.video.MediaCodecVideoRenderer;
import com.tangxiaolv.telegramgallery.exoplayer2.video.VideoRendererEventListener;
...
public class DefaultRenderersFactory implements RenderersFactory {
  ...
  protected void buildVideoRenderers(Context context,
    ...
    try {
      Class<?> clazz =
          Class.forName("com.tangxiaolv.telegramgallery.exoplayer2.ext.vp9.LibvpxVideoRenderer");
  ...
  protected void buildAudioRenderers(Context context,
    ...
    try {
      Class<?> clazz =
          Class.forName("com.tangxiaolv.telegramgallery.exoplayer2.ext.opus.LibopusAudioRenderer");
    ...
    try {
      Class<?> clazz =
          Class.forName("com.tangxiaolv.telegramgallery.exoplayer2.ext.flac.LibflacAudioRenderer");
      Constructor<?> constructor = clazz.getConstructor(Handler.class,
          AudioRendererEventListener.class, AudioProcessor[].class);
      Renderer renderer = (Renderer) constructor.newInstance(eventHandler, eventListener,
          audioProcessors);
    ...
    try {
      Class<?> clazz =
          Class.forName("com.tangxiaolv.telegramgallery.exoplayer2.ext.ffmpeg.FfmpegAudioRenderer");
      Constructor<?> constructor = clazz.getConstructor(Handler.class,
          AudioRendererEventListener.class, AudioProcessor[].class);
      Renderer renderer = (Renderer) constructor.newInstance(eventHandler, eventListener,
          audioProcessors);
