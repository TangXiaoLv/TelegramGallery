...
public final class C {
   ...
   */
  @Retention(RetentionPolicy.SOURCE)
  @IntDef({com.tangxiaolv.telegramgallery.exoplayer2.Format.NO_VALUE, ENCODING_INVALID, ENCODING_PCM_8BIT, ENCODING_PCM_16BIT,
  ...
  @Retention(RetentionPolicy.SOURCE)
  @IntDef({
      com.tangxiaolv.telegramgallery.exoplayer2.Format.NO_VALUE,
      STEREO_MODE_MONO,
   ...
   */
  @Retention(RetentionPolicy.SOURCE)
  @IntDef({com.tangxiaolv.telegramgallery.exoplayer2.Format.NO_VALUE, COLOR_SPACE_BT709, COLOR_SPACE_BT601, COLOR_SPACE_BT2020})
   ...
   */
  @Retention(RetentionPolicy.SOURCE)
  @IntDef({com.tangxiaolv.telegramgallery.exoplayer2.Format.NO_VALUE, COLOR_TRANSFER_SDR, COLOR_TRANSFER_ST2084, COLOR_TRANSFER_HLG})
   ...
   */
  @Retention(RetentionPolicy.SOURCE)
  @IntDef({com.tangxiaolv.telegramgallery.exoplayer2.Format.NO_VALUE, COLOR_RANGE_LIMITED, COLOR_RANGE_FULL})
