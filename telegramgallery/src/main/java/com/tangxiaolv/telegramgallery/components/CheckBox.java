...
public class CheckBox extends View {
    ...
    private boolean actionBarStyle;
    private boolean bottomBarStyle;

    public static int sCheckColor = 0xff007aff;
    ...
    public void setChecked(boolean checked, boolean animated) {
        if (checked == isChecked && number == -1 && !bottomBarStyle) {
            return;
        }
        isChecked = checked;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (drawBackground || progress != 0) {
            ...
            if (drawBackground) {
                paint.setColor(actionBarStyle ? 0xfff9f9f9 : 0x44000000);
                backgroundPaint.setColor(actionBarStyle ? 0xff9b9b9b : 0xffffffff);
            ...
            bitmapCanvas.drawCircle(getMeasuredWidth() / 2, getMeasuredHeight() / 2,
                    rad - (bottomBarStyle ? AndroidUtilities.dp(4) : 1), paint);
            bitmapCanvas.drawCircle(getMeasuredWidth() / 2, getMeasuredHeight() / 2,
    ...
    public void setActionBarStyle(boolean actionBarStyle) {
        this.actionBarStyle = actionBarStyle;
    }

    public void setBottomBarStyle(boolean bottomBarStyle) {
